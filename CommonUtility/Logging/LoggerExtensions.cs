...
namespace CommonUtility.Logging
{
    public static class LoggerExtensions
    {
        ...
        public static void Trace(this ILogger logger, Exception exception, IFormatProvider provider, string message,
            params object[] args)
        {
        ...
        public static void Debug(this ILogger logger, Exception exception, IFormatProvider provider, string message,
            params object[] args)
        {
        ...
        public static void Info(this ILogger logger, Exception exception, IFormatProvider provider, string message,
            params object[] args)
        {
        ...
        public static void Warn(this ILogger logger, Exception exception, IFormatProvider provider, string message,
            params object[] args)
        {
        ...
        public static void Error(this ILogger logger, Exception exception, IFormatProvider provider, string message,
            params object[] args)
        {
        ...
        public static void Fatal(this ILogger logger, Exception exception, IFormatProvider provider, string message,
            params object[] args)
        {
        ...
        public static void None(this ILogger logger, Exception exception, IFormatProvider provider, string message,
            params object[] args)
        {
